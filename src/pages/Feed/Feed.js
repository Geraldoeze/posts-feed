...
class Feed extends Component {
  ...
  updatePost = post => {
    this.setState(prevState => {
      ...
      const updatedPostIndex = updatePosts.findIndex(p => p._id === post._id);
      if (updatedPostIndex > -1) {
        updatePosts[updatedPostIndex] = post;
      }
      return {
        posts: updatePosts
      }
  ...
  loadPosts = direction => {
    ...
    fetch('https://rest-api-indol-nine.vercel.app/feed/posts?page=' + page, {
      headers: {
        Authorization: 'Bearer ' + this.props.token
      }
  ...
  deletePostHandler = postId => {
    ...
    fetch('https://rest-api-indol-nine.vercel.app/feed/post/' + postId, {
      method: 'DELETE',
      headers: {
        Authorization: 'Bearer ' + this.props.token
      }
